...
class Result extends Component {
  ...
  printDelete = () => {
    return (
      ...
      >
        <defs></defs>
        <title>Delete your garden</title>
        <path 
  ...
  render = () => {
    return (
      <div
        ...
        style={{
          border: 
            this.state.garden.name === this.context.state.currentOption
            ? "1px solid black" 
            : "0"
        }}
      >
        <div
          ...
          onClick={() => this.context.functions.loadGarden(this.state.garden)}
        >
...
Result.contextType = GardenContext
